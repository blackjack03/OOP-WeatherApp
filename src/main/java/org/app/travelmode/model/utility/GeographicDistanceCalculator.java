...
public final class GeographicDistanceCalculator {
    private static final double EARTH_RADIUS = 6_372.795_477_598;
    ...
    public static BigDecimal computeDistance(final LatLng p1, final LatLng p2) {
        ...
        return BigDecimal.valueOf(EARTH_RADIUS
                        * Math.acos(Math.sin(radiantLat1) * Math.sin(radiantLat2) + Math.cos(radiantLat1)
                        * Math.cos(radiantLat2) * Math.cos(radiantLng1 - radiantLng2)) * 1000)
